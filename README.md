...
Web Safety runs on modern versions of FreeBSD (pfSense), CentOS, Debian and Ubuntu Linux, providing comprehensive web filtering solution easily manageble from Web UI.
